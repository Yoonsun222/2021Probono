...
export default function No6({ navigation }) {
    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <Grid style={{ marginTop: 10 }}>
          ...
          <Col size={45}>
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}> 임노인</Text>
            </Row>
            <Row style={styles.cell}>
            ...
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}>1943.06.06</Text>
            </Row>
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}>010-0000-0006</Text>
            </Row>
            <Row style={styles.cell}>
            ...
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}>010-0006-0006</Text>
            </Row>
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}>-</Text>
            </Row>
