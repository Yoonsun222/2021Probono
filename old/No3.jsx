...
export default function No3({ navigation }) {
    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <Grid style={{ marginTop: 10 }}>
          ...
          <Col size={45}>
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}> 다노인</Text>
            </Row>
            <Row style={styles.cell}>
            ...
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}>1950.03.01</Text>
            </Row>
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}>010-0000-0003</Text>
            </Row>
            <Row style={styles.cell}>
            ...
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}>010-0003-0003</Text>
            </Row>
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}>-</Text>
            </Row>
