...
export default function No11({ navigation }) {
    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <Grid style={{ marginTop: 10 }}>
          ...
          <Col size={45}>
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}> 김노인</Text>
            </Row>
            <Row style={styles.cell}>
            ...
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}>1950.11.11</Text>
            </Row>
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}>010-1111-2222</Text>
            </Row>
            <Row style={styles.cell}>
            ...
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}>010-3333-4444</Text>
            </Row>
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}>-</Text>
            </Row>
