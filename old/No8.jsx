...
export default function No8({ navigation }) {
    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <Grid style={{ marginTop: 10 }}>
          ...
          <Col size={45}>
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}> 이노인</Text>
            </Row>
            <Row style={styles.cell}>
            ...
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}>1937.08.08</Text>
            </Row>
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}>010-0000-0008</Text>
            </Row>
            <Row style={styles.cell}>
            ...
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}>010-0008-0008</Text>
            </Row>
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}>-</Text>
            </Row>
