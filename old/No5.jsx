...
export default function No5({ navigation }) {
    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <Grid style={{ marginTop: 10 }}>
          ...
          <Col size={45}>
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}> 마노인</Text>
            </Row>
            <Row style={styles.cell}>
            ...
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}>1948.05.05</Text>
            </Row>
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}>010-0000-0005</Text>
            </Row>
            <Row style={styles.cell}>
            ...
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}>010-0005-0005</Text>
            </Row>
            <Row style={styles.cell}>
              <Text style={{ fontSize: 15 }}>-</Text>
            </Row>
